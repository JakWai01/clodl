...
(deftest spaces-test
  (testing "Testing spaces with valid args"
    (is (= "  " (util/spaces 2)))
    (is (= "" (util/spaces 0))))
  (testing "Testing spaces with invalid args"
    (is (= "  " (util/spaces "2")))
    (is (= "" (util/spaces "0")))))
...
(deftest colorize-string-test
  ...
  (testing "Testing colorize-tring with invalid args"
    (is (= (str "FIXME") (util/colorize-string 1)))))
...
(deftest get-printed-len-test
  ...
  (testing "Testing get-printed-len with invalid args"
    (is (= "FIXME" (util/get-printed-len 7)))))